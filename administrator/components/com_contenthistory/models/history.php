...
class ContenthistoryModelHistory extends JModelList
{
	 ...
	 * @since   3.2
	 */
	public function getTable($type = 'History', $prefix = 'ContenthistoryTable', $config = array())
	{
	...
	protected function getListQuery()
	{
		...
		->from($db->quoteName('#__content_ucm_history') . ' AS h')
	...
	protected function getSha1Hash()
	{
		...
		if ($contentTable && $contentTable->load($keyValue))
		{
			...
			$result = $this->getTable('ContenthistoryTableHistory', 'JTable')->getSha1(json_encode($dataObject), $typeTable);
		}
