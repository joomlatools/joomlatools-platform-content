...
class ContentTableUcmBase implements ContentTableUcm
{
	 ...
	 * @since   3.1
	 */
	public function __construct($alias = null, ContentTableUcmType $type = null)
	{
		// Setup dependencies.
	...
	protected function store($data, JTableInterface $table = null, $primaryKey = null)
	{
		if (!$table)
		{
			$table = JTable::getInstance('Base', 'ContentTable');
		}
	 ...
	 * @param   ContentTableUcmType  $type      UCM Content Type
	 *
	 * @return  array  Data array of UCM mappings
	 *
	 * @since   3.1
	 */
	public function mapBase($original, ContentTableUcmType $type = null)
	{
