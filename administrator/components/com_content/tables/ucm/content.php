...
class ContentTableUcmContent extends ContentTableUcmBase
{
	...
	/**
	 * Instantiate ContentTableUcmContent.
	 *
	 * @param   JTableInterface         $table  The table object
	 * @param   string                  $alias  The type alias
	 * @param   ContentTableUcmType     $type   The type object
	 *
	 * @since   3.1
	 */
	 ...
	 * @param   ContentTableUcmType  $type      The UCM Type object
	 *
	 * @return  boolean  true
	 *
	 * @since   3.1
	 */
	public function save($original = null, ContentTableUcmType $type = null)
	{
	 ...
	 * @param   ContentTableUcmType  $type  The content type object
	 *
	 * @return  boolean  True if success
	 *
	 * @since   3.1
	 */
	public function delete($pk, ContentTableUcmType $type = null)
	{
		$db   = JFactory::getDbo();
		$type = $type ? $type : $this->type;
	 ...
	 * @since   3.1
	 */
	public function mapData($original, ContentTableUcmType $type = null)
	{
	...
	{
		$table = $table ? $table : JTable::getInstance('Core', 'ContentTable');
	...
	public function getPrimaryKey($typeId, $contentItemId)
	{
		...
		$queryccid->select($db->quoteName('ucm_id'))
			->from($db->quoteName('#__content_ucm_base'))
			->where(
				array(
