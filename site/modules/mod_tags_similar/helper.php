...
abstract class ModTagssimilarHelper
{
	...
	public static function getList(&$params)
	{
		...
		$query->from($db->quoteName('#__content_tags_map', 'm'));

		$query->join('INNER', $db->quoteName('#__content_tags', 't') . ' ON m.tag_id = t.id')
			->join('INNER', $db->quoteName('#__content_ucm_core', 'cc') . ' ON m.core_content_id = cc.core_content_id')
